...
class EfficientFormerV2(nn.Module):
    ...
    def forward(self, x):
        ...
        low_feature, x = self.forward_tokens(x)
...
def efficientformerv2_s0(downsample_factor=8,pretrained=True, **kwargs):
    model = EfficientFormerV2(
        ...
        **kwargs)
    weights='/home/nypyp/code/hgnetv2-deeplabv3/model_data/eformer_s0_450.pth'
    if pretrained:
        pretrained_weight = torch.load(weights)['model']
        model.load_state_dict(update_weight(model.state_dict(), pretrained_weight))
    return model

def efficientformerv2_s1(downsample_factor=8,pretrained=True, **kwargs):
    model = EfficientFormerV2(
        ...
        **kwargs)
    weights='/home/nypyp/code/hgnetv2-deeplabv3/model_data/eformer_s1_450.pth'
    if pretrained:
        pretrained_weight = torch.load(weights)['model']
        model.load_state_dict(update_weight(model.state_dict(), pretrained_weight))
    return model

def efficientformerv2_s2(downsample_factor=8,pretrained=True, **kwargs):
    model = EfficientFormerV2(
        ...
        **kwargs)
    weights='/home/nypyp/code/hgnetv2-deeplabv3/model_data/eformer_s2_450.pth'
    if pretrained:
        pretrained_weight = torch.load(weights)['model']
        model.load_state_dict(update_weight(model.state_dict(), pretrained_weight))
    return model

def efficientformerv2_l(downsample_factor=8,pretrained=True, **kwargs):
    model = EfficientFormerV2(
        ...
        e_ratios=expansion_ratios_L,
        **kwargs)
    weights='/home/nypyp/code/hgnetv2-deeplabv3/model_data/eformer_l_450.pth'
    if pretrained:
        pretrained_weight = torch.load(weights)['model']
        model.load_state_dict(update_weight(model.state_dict(), pretrained_weight))
    return model
